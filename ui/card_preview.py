"""
Widget de preview dos cards â€” renderiza o card visualmente usando QPainter.
...
class CardRenderer(QWidget):
    """Widget que desenha um Ãºnico card usando QPainter."""
    ...
    def paintEvent(self, event):
        ...
        # Fundo cinza claro da Ã¡rea de preview
        ...
        # --- Calcular dimensÃµes do card mantendo proporÃ§Ã£o 16:10 ---
        ...
        # Escala de fonte: card_w como referÃªncia (LaTeX card = ~453pt â†’ card_w pixels)
        scale = card_w / 453.0
...
def _draw_centered_wrapped_text(
    ...
    """Desenha texto centralizado com wrap automÃ¡tico de linha."""
    if not text:
        return
...
class CardPreviewWidget(QWidget):
    """
    Painel direito: Preview completo com navegaÃ§Ã£o entre cards.
    """
    ...
    def _setup_ui(self):
        ...
        self._btn_prev = QPushButton("â—€  Anterior")
        ...
        self._btn_next = QPushButton("PrÃ³ximo  â–¶")
