...
class PdfThread(QThread):
    """Thread para geração de PDF sem travar a UI."""
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self._setup_window()
        self._setup_ui()
        # Inicializa o contador no cabeçalho logo na abertura
        self._on_dados_alterados()

    def _setup_window(self):
        self.setWindowTitle("Gerador de Cards — Colação de Grau PROGRAD/UFSM")
